...
import com.example.caspian.taskmanager.UriConverter;
...
public class Task {
    ...
    @Keep
    public Task(Long id, UUID mId, String mTitle, String mDescribtion,
            Long maccountId, Date mDate, boolean mDone, String photoAddress) {
        this.id = id;
        this.mId = mId;
        this.mTitle = mTitle;
